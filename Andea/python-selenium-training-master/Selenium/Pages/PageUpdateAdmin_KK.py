...
from Selenium.Locators.Loc_PageUpdateAdmin_KK import Loc_PageUpdateAdmin_KK


class PageUpdateAdmin_KK(SeleniumDriver, Loc_PageUpdateAdmin_KK):
    """ This class stores all methods that can be used for Update Admin page """
    ...
    def UpdateAdmin(self, first_name, last_name, email, password, number, country, address1, address2):
