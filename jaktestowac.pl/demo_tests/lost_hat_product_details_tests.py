...
class LostHatProductDetailsTests(BaseTestClass):
    ...
    def test_check_product_size_change(self):
        ...
        observed_product_size_changed_value = product_size_select_element.get_property('value')
        ...
        self.assertEqual(expected_product_default_size, observed_product_size_changed_text,
                         f'Expected size differ from actual on page: {driver.current_url}')
